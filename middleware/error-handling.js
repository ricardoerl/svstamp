...
export class DBConnectionError extends Error {
	constructor() {
		...
		this.description = "Hubo un error al verificar el enlace, por favor intenta en otro momento.";
		this.type = "error";
	}
}
...
export class StoreError extends Error {
	constructor() {
		...
		this.description = "Hubo un error al guardar el enlace, por favor intenta en otro momento.";
		this.type = "error";
	}
}
